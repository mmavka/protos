...
type SetAdminRequest struct {
	...
	UserId  int64  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`    // User ID to set as an admin.
	IsAdmin bool   `protobuf:"varint,2,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates whether the user should be an admin or not.
	AppId   int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`       // ID of the app to set the user as an admin for.
	AdminId int64  `protobuf:"varint,4,opt,name=admin_id,json=adminId,proto3" json:"admin_id,omitempty"` // ID of the admin setting the user as an admin.
	Token   string `protobuf:"bytes,5,opt,name=token,proto3" json:"token,omitempty"`                     // Auth token of the admin setting the user as an admin.
}
...
func (x *SetAdminRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *SetAdminRequest) GetAdminId() int64 {
	if x != nil {
		return x.AdminId
	}
	return 0
...
func (x *SetAdminRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SetAdminResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x8d, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x74, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x18, 0x02,
	...
	0x70, 0x70, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x5f, 0x69, 0x64,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2d, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69,
	...
	0x64, 0x6d, 0x69, 0x6e, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x22, 0x43, 0x0a,
	...
	0xe6, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	...
	0x08, 0x53, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68,
	0x2e, 0x53, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x16, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x6d, 0x6d, 0x61, 0x76,
	0x6b, 0x61, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62,
...
var file_sso_sso_proto_goTypes = []interface{}{
	(*SetAdminRequest)(nil),  // 0: auth.SetAdminRequest
	(*SetAdminResponse)(nil), // 1: auth.SetAdminResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	0, // 3: auth.Auth.SetAdmin:input_type -> auth.SetAdminRequest
	5, // 4: auth.Auth.Register:output_type -> auth.RegisterResponse
	7, // 5: auth.Auth.Login:output_type -> auth.LoginResponse
	3, // 6: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
	1, // 7: auth.Auth.SetAdmin:output_type -> auth.SetAdminResponse
